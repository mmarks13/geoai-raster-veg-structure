"""
Raster prediction head: cross-attention grid aggregation + FFN + small MLP decoder.
...
class CrossAttnGridMlpHead(nn.Module):
    """Cross-attention grid aggregation + Pre-LN FFN + small MLP decoder."""
    ...
    def __init__(
        ...
        # Fall back to the shared `dropout` value when a site-specific value
        # isn't provided.
