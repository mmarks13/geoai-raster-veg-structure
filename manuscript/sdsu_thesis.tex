...
\begin{center}
\vspace*{0.5in}
{\Large SIGNATURE PAGE}\\[1.5cm]
\end{center}

\noindent
The undersigned committee hereby approves the thesis of\\[0.3cm]
\textbf{\thesisauthor}\\[0.3cm]
presented on \underline{\hspace{3in}}\\[1.2cm]

\noindent
Title: \thesistitle\\[1.2cm]

\noindent
\rule{3in}{0.4pt}\\
Daniel Sousa, PhD\\
Committee Co-Chair\\
Department of Geography\\[1cm]
...
Funding for the research was provided by California Climate Action Matching Grants, University of California, Office of the President (grant \#R02CM708 to M. Jennings, SDSU (PI) and JF). DS gratefully acknowledges funding from the NASA FireSense program (Grant \#\allowbreak 80NSSC24K0145), the NASA FireSense Implementation Team (Grants \#\allowbreak 80NSSC24K1320), the NASA Land-Cover/Land Use Change program (Grant \#\allowbreak NNH21ZDA001N-\allowbreak LCLUC), the EMIT Science and Applications Team program (Grant \#\allowbreak 80NSSC24K0861), the NASA Remote Sensing of Water Quality program (Grant \#\allowbreak 80NSSC22K0907), the NASA Applications-Oriented Augmentations for Research and Analysis Program (Grant \#\allowbreak 80NSSC23K1460), the NASA Commercial Smallsat Data Analysis Program (Grant \#\allowbreak 80NSSC24K0052), the USDA NIFA Sustainable Agroecosystems program (Grant \#\allowbreak 2022-\allowbreak 67019-\allowbreak 36397), the USDA AFRI Rapid Response to Extreme Weather Events Across Food and Agricultural Systems program (Grant \#\allowbreak 2023-\allowbreak 68016-\allowbreak 40683), the California Climate Action Seed Award Program, and the NSF Signals in the Soil program (Award \#\allowbreak 2226649).
