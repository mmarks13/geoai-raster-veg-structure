...
of the Requirements for the Degree\\[1cm]

{\Large \thesisdegree}\\[1.5cm]
...
\begin{center}
\vspace*{1in}
{\Large SIGNATURE PAGE}\\[2cm]
\end{center}

\noindent
The undersigned committee hereby approves the thesis of\\[0.3cm]
\textbf{\thesisauthor}\\[0.3cm]
presented on \underline{\hspace{3in}}\\[2cm]

\noindent
Title: \thesistitle\\[2cm]

\noindent
\rule{3in}{0.4pt}\\
Daniel Sousa, PhD\\
Committee Co-Chair\\
Department of Geography\\[1.5cm]
...
\textls[-15]{Our multi-modal upsampling framework transforms a sparse 3DEP point cloud, plus co-registered NAIP and UAVSAR image chips, into a denser 3D point cloud (Figure~\ref{fig:pipeline}). The network is built around the \textit{Local–Global Point Attention Block
} (LG-PAB; Section
...
% --- LG-PAB (its own page) ---------------------------------------------------
% \clearpage
\section{The Local–Global Point Attention Block (LG-PAB)}
\label{sec:lgpab}
...
\section{End-to-End Upsampling Pipeline}
\label{sec:pipeline}
...
The authors wish to express their sincere gratitude to Lloyd L. ("Pete") Coulter (Center for Earth Systems Analysis Research, Department of Geography, SDSU) for his skillful piloting and management of all UAV LiDAR data acquisition campaigns; this data was foundational to the research presented.
...
% APPENDIX
\appendix
\chapter{Detailed Layer Specifications}
\label{app1}
\chapterstart
...
\newblock In \emph{Merging Science and Management in a Rapidly
  Changing World: Biodiversity and Management of the Madrean Archipelago III}; USDA Forest Service Proceedings RMRS-P-67; U.S. Department of Agriculture, Forest Service, Rocky Mountain Research Station: Fort Collins, CO, USA
, 2013; pp. 389--395.
...
Agee, J.K.
\newblock The Influence of Forest Structure on Fire Behavior. In Proceedings of the 17th Annual Forest Vegetation Management Conference, Redding, CA, USA, 16–18 January
 1996;
\newblock pp. 52--68.
...
\newblock \emph{J. Phys. Conf. Ser.} \textbf{2019}, \emph{1399}, 055024
.
...
USGS.
\newblock \emph{What Is {3DEP}?}; U.S. Geological Survey: Reston, VA, USA
, 2019.

\bibitem[USDA(2024)]{usda_naip_2024}
USDA.
\newblock \emph{National Agriculture Imagery Program---NAIP Hub Site}; USDA: Washington, DC, USA
, 2024.
...
\newblock UAVSAR: A new NASA airborne SAR system for science and technology
  research.
\newblock In Proceedings of the 2006 IEEE Conference on Radar, Verona, NY, USA, 24--27 April 2006
...
\newblock In Proceedings of the 2020 IEEE Aerospace Conference, Big Sky, MT, USA, 7--14 March 2020; IEEE: Piscataway, NJ, USA, 2020;
  pp. 1--21.
...
\newblock In~{\em Advances in Neural Information Processing Systems}; Neural Information Processing Systems Foundation, Inc.: San Diego, CA, USA
, 2017; Volume 30.
...
\newblock Mapping Forest Canopy Height Across Large Areas by Upscaling {ALS}
  Estimates with Freely Available Satellite Data. \emph{Remote Sens.
} {\bf 2015},
\newblock {\em 7}, 12563--12587
.
...
\newblock Sub-meter tree height mapping of California using aerial images and
  {LiDAR}-informed U-Net model. \emph{Remote Sens. Environ.} {\bf 2024}, {\em 305}, 114099.
...
Remijnse, T.
\newblock Upsampling LiDAR Point Clouds of Forest Environments Using Deep Learning. Master's Thesis, Wageningen University and Research, Wageningen, The Netherlands
, 2024.
...
\newblock In Proceedings of the IEEE Conference on Computer
  Vision and Pattern Recognition, Salt Lake City, UT, USA, 18--23 June 2018; pp. 2790--2799.
...
\newblock In~Proceedings of the IEEE/CVF Conference on
  Computer Vision and Pattern Recognition, Nashville, TN, USA, 20--25 June 2021; \mbox{pp. 11683--11692}.
...
\newblock In Proceedings of the Asian Conference on Computer
  Vision, Macao, China, 4--8 December 2022; pp. 2475--2493.
...
\newblock In \emph{Advances in Guidance, Navigation and Control
, Proceedings of the International Conference on Guidance,
  Navigation and Control}; Springer: Berlin/Heidelberg, Germany, 2024; pp. 533--542.
...
\newblock In Proceedings of the Computer Vision---ECCV 2020: 16th European  Conference, Glasgow, UK, 23--28 August 2020; Proceedings, Part XXVII 16; Springer: Berlin/Heidelberg, Germany, 2020; pp. 720--736.
...
\newblock In Proceedings of the IEEE/CVF International
  Conference on Computer Vision, Montreal, QC, Canada, 10--17 October 2021; pp. 16259--16268.
...
{USGS}.
\newblock \emph{{USGS} 3DEP---{CA} {SanDiego} 2015 C17 1}; USGS: Reston, VA, USA
, 2016.
...
Microsoft.
\newblock \emph{Microsoft {Planetary} {Computer}}; Microsoft: Redmond, WA, USA
, 2025.

\bibitem[{Alaska Satellite Facility}(2024)]{alaska_search}
{Alaska Satellite Facility}.
\newblock {\emph{ASF Search Python API}}; Alaska Satellite Facility: Fairbanks, AK, USA, 2024.
...
\newblock Advancements in point cloud data augmentation for deep learning: A
  survey.
\newblock {\em Pattern Recognit.} {\bf 2024}, \emph{153
}, 110532.
...
\newblock {\em J. Big Data} {\bf 2019}, {\em 6}, 60
.
...
\newblock In Proceedings of the IEEE/CVF International
  Conference on Computer Vision (ICCV), Montreal, QC, Canada, 10--17 October 2021; pp. 32--42.
...
\newblock In Proceedings of the 38th International
  Conference on Machine Learning (ICML), Virtual, 18--24 July 2021; Volume 139, pp. 2286--2296.
...
\newblock The Road Less Scheduled. \emph{arXiv
} \textbf{2024}.
...
\newblock \url{https://github.com/Clay-foundation/model} (accessed on 20 November 2025
).
